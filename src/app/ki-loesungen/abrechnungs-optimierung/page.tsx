...
import { ArrowRight, Calculator, Search, BarChart3, FileWarning, ShieldCheck, Scale } from "lucide-react";
import heroBg from "../../../../public/images/hero_bg.png";

export const metadata: Metadata = {
  title: "Abrechnungs-Optimierung",
  description:
    "KI-basierte Erkennung fehlender Abrechnungsziffern und Optimierungspotenziale für EBM, GOÄ und HZV.",
};
...
const features = [
  ...
  },
  {
    ...
    description: "Übersichtliche Auswertungen mit Trend-Analysen und Fachgruppenvergleich gegen Durchschnittswerte.",
  },
  {
    icon: FileWarning,
    title: "Fallspezifische Begründungen",
    description: "Jede Optimierungs-Empfehlung wird mit einer konkreten, fallbezogenen Begründung hinterlegt.",
  },
  {
    icon: Scale,
    title: "Fachgruppenvergleich",
    description: "Vergleichen Sie Ihre GOP-Nutzungsraten mit dem Fachgruppen-Durchschnitt und identifizieren Sie Potenziale.",
  },
  {
    icon: ShieldCheck,
    title: "DSGVO-konform",
    description: "Vollständige Pseudonymisierung — keine Klarnamen, nur anonymisierte Patientendaten.",
  },
];
    ...
    <>
      ...
      <section className="py-14 bg-snow">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="text-base text-midnight/50 mb-8">Erfahren Sie, wie Sie mit der Abrechnungs-Optimierung Ihre Erlöse steigern können.</p>
